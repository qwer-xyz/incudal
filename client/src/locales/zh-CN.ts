export default {
    ...
    nav: {
        ...
        myPackageEdit: '编辑套餐',
        myPackagePlanCreate: '创建方案',
        myPackagePlanEdit: '编辑方案',
    ...
    wallet: {
        ...
        redeemCard: '兑换卡密',
        rechargeCardNo: '卡密编号',
        rechargeCardPassword: '卡密密码',
        rechargeCardNoPlaceholder: '输入卡密编号',
        rechargeCardPasswordPlaceholder: '输入卡密密码',
        cardCredentialRequired: '请输入卡密编号和密码',
        cardRedeemSuccess: '卡密兑换成功，余额已到账',
        redeemCardFailed: '卡密兑换失败',
        void: '作废',
        logTypes: {
            recharge: '充值',
            consume: '消费',
    ...
    aff: {
        ...
        affDisabledByAdmin: 'AFF 返利暂未开启',
        affDisabledByAdminHint: '管理员尚未开放 AFF 返利功能，当前无法创建优惠码。功能开启后可在此创建并管理优惠码。',
        goRecharge: '前往充值',
        affBalance: 'AFF 余额',
        totalEarnings: '累计收益',
        ...
        promoCodeDisabledByAdmin: '管理员暂未开启 AFF 返利，当前无法使用优惠码',
    ...
    instance: {
        ...
        subscription: {
            ...
            applyAffDisabledByAdmin: '管理员暂未开启 AFF 返利，当前无法绑定优惠码。',
    ...
    admin: {
        ...
        system: {
            ...
            affRebate: {
                ...
                affRebateEnabled: '允许 AFF 返利',
                affRebateEnabledDesc: '开启后，用户可以创建、校验和绑定 AFF 优惠码；关闭后前台开通实例、实例详情绑定和后端接口都会拒绝使用优惠码。',
                enabled: '允许',
                disabled: '禁止',
            },
            hostingFeature: {
        ...
        users: {
            ...
            createUserPage: {
                title: '创建用户',
                description: '为平台直接创建新用户，可选择先验证邮箱或一次性展示随机初始密码',
                username: '用户名',
                usernamePlaceholder: '如：demo_user',
                usernameHint: '3-32 位，必须以字母开头，仅支持字母、数字、下划线和连字符',
                email: '邮箱',
                emailPlaceholder: 'user@example.com',
                verifyEmail: '验证邮箱',
                verifyEmailHint: '开启后需要先发送并填写邮箱验证码；创建成功后初始密码会发送到该邮箱',
                emailCode: '邮箱验证码',
                emailCodePlaceholder: '输入 6 位验证码',
                sendCode: '发送验证码',
                resendIn: '{seconds}s 后可重发',
                codeSent: '验证码已发送',
                codeExpiresAt: '验证码有效期至 {time}',
                bannedHint: '封禁状态创建后该用户暂不能登录',
                submit: '创建用户',
                createSuccess: '用户创建成功',
                resultTitle: '用户已创建',
                resultDisplayDesc: '初始密码只会在此处显示一次，请复制后安全交付给用户。',
                resultEmailDesc: '初始密码已发送到用户邮箱，页面不会展示密码。',
                initialPassword: '初始密码',
                copyPassword: '复制密码',
                passwordOnceHint: '关闭或离开此页面后将无法再次查看该密码。',
                passwordEmailHint: '密码已通过邮件交付给用户。',
                continueCreate: '继续创建',
                backToUsers: '返回用户列表'
            },
        ...
        rechargeCards: {
            ...
            usedFrom: '使用开始时间',
            usedTo: '使用结束时间',
            createdTimeRange: '生成时间',
            usedTimeRange: '使用时间',
            statusLabel: '状态',
            allStatus: '全部状态',
            minAmount: '最小金额',
            maxAmount: '最大金额',
            searchPlaceholder: '搜索卡密编号',
            empty: '暂无充值卡密',
            selectedCount: '已选择 {count} 张',
            exportSelected: '导出选中 ({count})',
            deleteSelected: '删除选中 ({count})',
            selectForExport: '请选择要导出的卡密',
            selectForDelete: '请选择要删除的卡密',
            generatedResult: '本次生成结果',
            copyAll: '复制全部',
            exportGenerated: '导出本次生成',
            generatedCopyLine: '卡号：{cardNo} 密码：{password} 金额：{amount}',
            generateSuccess: '卡密生成成功',
            generateFailed: '生成卡密失败',
            invalidAmount: '请输入有效金额',
            invalidCount: '生成数量需在 1-1000 之间',
            exportSuccess: '导出已开始',
            exportFailed: '导出失败',
            deleteConfirm: '确定删除未使用卡密 {cardNo}？',
            deleteSuccess: '卡密已删除',
            deleteFailed: '删除卡密失败',
            deleteSelectedConfirm: '确定删除选中的 {count} 张卡密？已使用卡密和不存在的卡密会自动跳过。',
            deleteSelectedSuccess: '已删除 {deleted} 张卡密，跳过 {skipped} 张',
            deleteSelectedFailed: '批量删除卡密失败',
            loadFailed: '加载充值卡密失败',
            status: {
                unused: '未使用',
                used: '已使用',
    ...
    errors: {
        ...
        TRAFFIC_RESET_NOT_ALLOWED: '当前实例不允许自助重置流量',
        TRAFFIC_RESET_NOT_NEEDED: '当前没有可重置的流量用量',
    ...
    traffic: {
        ...
        nextReset: '下次重置',
        resetTitle: '流量重置',
        resetPriceInfo: '可重置本周期已用流量，费用 {price}/次',
        resetAction: '重置流量',
        resetNoUsage: '当前没有已用流量，无需重置',
        resetConfirmTitle: '确认重置流量',
        resetConfirmSubtitle: '费用将从账户余额扣除',
        resetCurrentUsage: '当前已用',
        resetCost: '重置费用',
        resetConfirmBody: '确认后将把本周期已用流量归零，历史流量记录不会删除。此操作完成后不可撤销。',
    ...
    resources: {
        ...
        plans: {
            ...
            listDescription: '管理用户可购买的付费实例方案，状态可以直接在列表中切换',
            add: '添加方案',
            create: '创建方案',
            edit: '编辑方案',
            formDescription: '配置付费实例方案的资源、计费和状态',
            basicInfo: '基础信息',
            ...
            saveFailed: '保存方案失败',
            statusUpdateSuccess: '方案状态已更新',
            statusUpdateFailed: '更新方案状态失败',
            priceRangeHint: '最高 ¥{max}',
            priceRangeError: '方案价格必须在 0-{max} 元之间，最多支持两位小数',
            trafficReset: '流量重置',
            trafficResetDisabled: '未启用',
            allowTrafficReset: '允许用户重置流量',
            allowTrafficResetHint: '开启后，实例所有者可在流量页付费重置本周期已用流量',
            trafficResetPrice: '重置价格',
            trafficResetPriceHint: '每次重置扣除的余额，0 表示免费',
            trafficResetPriceRangeError: '流量重置价格必须在 0-{max} 元之间，最多支持两位小数',
            perReset: '次',
